...
/// Full Width Media Card - Style 1 (Full width, no padding)
/// Supports: single media, multi-grid, auto-slider, videos, backgrounds
class FullWidthMediaCard extends StatefulWidget {
  // Single media mode
  ...
  @override
  State<FullWidthMediaCard> createState() => _FullWidthMediaCardState();
}

class _FullWidthMediaCardState extends State<FullWidthMediaCard> {
  ...
  @override
  void didUpdateWidget(FullWidthMediaCard oldWidget) {
  ...
  BoxDecoration _buildBackgroundDecoration() {
    ...
    switch (widget.background!.type) {
      case MediaBackgroundType.color:
        return BoxDecoration(color: widget.background!.color);
...
enum MediaBackgroundType { color, image, gif, video }

class MediaCardBackground {
  final MediaBackgroundType type;
  final Color? color;

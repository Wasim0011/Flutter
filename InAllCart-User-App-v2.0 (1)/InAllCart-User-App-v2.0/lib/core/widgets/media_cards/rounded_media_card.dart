...
/// Rounded Media Card - Style 3 (Rounded corners with padding)
/// Supports: single media, multi-grid, auto-slider, videos, backgrounds
class RoundedMediaCard extends StatefulWidget {
  // Single media mode
  ...
  @override
  State<RoundedMediaCard> createState() => _RoundedMediaCardState();
}

class _RoundedMediaCardState extends State<RoundedMediaCard> {
  ...
  @override
  void didUpdateWidget(RoundedMediaCard oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.background != null) {
      // Edge-to-edge background (no horizontal padding)

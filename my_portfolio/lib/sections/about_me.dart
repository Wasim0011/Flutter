import 'package:my_portfolio/components/app_button.dart';
    ...
    yield section(classes: 'about-me-section', [
      ...
      div(classes: 'about-section-body', [
        ...
        div(classes: 'about-details', [
          span(
              classes: 'intro-label',
              styles: Styles.text(color: themePrimaryColor, fontWeight: FontWeight.bold, fontSize: Unit.pixels(30),),
              [
                text('Who am I?'),
              ]),
          ...
          div(classes: 'personal-row', [
            div([
              ...
              span(classes: 'personal-value',
                  styles: Styles.text(color: Colors.goldenRod),
                  [
          ...
          div(classes: 'personal-row', [
            div([
              ...
              span(classes: 'personal-value', styles: Styles.text(color: Colors.goldenRod),
                  [
  ...
  static final List<StyleRule> styles = [
    ...
    css('.profile-picture')
      ...
      size: BackgroundSize.cover,
        ...
        .box(
      height: 550.px,
      width: 550.px, // Make height and width equal
    ...
    //       height: 700.px,
    //       width: 540.px,
    //       margin: EdgeInsets.only(right: 80.px),
    //     ),
    css('.about-details')
        .flexbox(
          direction: FlexDirection.column,
